/**
 * Test webhook endpoint #2
 * This endpoint is for testing webhook registration with a different URL
...
export async function GET(request: NextRequest) {
  ...
  console.log('');
  console.log('🧪 TEST ENDPOINT 2 - CRC Request');
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('');
    console.log('🧪 TEST ENDPOINT 2 - Webhook Event Received');
    console.log('   Timestamp:', new Date().toISOString());
    ...
    return NextResponse.json({
      success: true,
      message: 'Test endpoint 2 received webhook',
