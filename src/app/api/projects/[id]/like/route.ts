/**
 * Project Like/Unlike Endpoint
 *
 * POST: Like or unlike a tweet on behalf of the project's bot
 *
 * This endpoint allows projects to like/unlike tweets
...
export async function POST(
  ...
  let body: LikeRequest | undefined;
  ...
  try {
    ...
    console.log('');
    console.log('================================================================================');
    console.log('❤️ PROJECT LIKE REQUEST');
    console.log('================================================================================');
    ...
    try {
      ...
      if (action === 'unlike') {
        console.log('💔 Attempting to unlike tweet:', body!.tweetId);
        result = await v2Client.unlike(bot.userId, body!.tweetId);
        console.log('✅ Unlike successful');
      } else {
        console.log('❤️ Attempting to like tweet:', body!.tweetId);
        result = await v2Client.like(bot.userId, body!.tweetId);
        ...
        await saveRateLimit(
          {
            ...
            endpoint: action === 'unlike' ? 'DELETE /2/users/:id/likes/:tweet_id' : 'POST /2/users/:id/likes',
    ...
    console.error('❌ Error in project like endpoint:', {
